...
if($_SERVER['REQUEST_METHOD']=='POST'){
 ...
 $stmt = $conn->prepare("INSERT INTO healthM (name,height,weight,temperature,lung,bp,sugar) VALUES (?,?,?,?,?,?,?)");

 //binding the parameter to statement
 $stmt->bind_param("s","s","s","s","s","s","s", $name,$height,$weight,$temperature,$lung,$bp,$sugar);
