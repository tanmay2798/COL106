...
//		Printobj(objroot);
	...
	static void transform(binID n, binID new1) {
		...
		if(n==binrootid && new1==binrootid) {
			if(lh-rh>1 ) {
				...
				binID y = n.left;
				binID z = n;
				binID temp = new binID(y,null,z.right,z.capacity,z.binID,z.pointbin,z.objects);
				...
				if(y.right!=null) {
					temp.left = new binID(y.parent,y.right.left,y.right.right,y.right.capacity,y.right.binID,y.right.pointbin,y.right.objects);
					temp.left.parent=temp;
				}else
					temp.left=null;
			...
			if(lh-rh<-1) {  
				...
				binID y = n.right;
				binID z = n;
				binID temp = new binID(y,z.left,null,z.capacity,z.binID,z.pointbin,z.objects);
				y.pointbin.pointBinID=y;
				z.pointbin.pointBinID=temp;
				if(temp.left!=null) {
					temp.left.parent=temp;
				...
				if(y.left!=null) {
					temp.right = new binID(y.parent,y.left.left,y.left.right,y.left.capacity,y.left.binID,y.left.pointbin,y.left.objects);
					temp.right.parent=temp;
				}else
					temp.right=null;
			...
			if(lh-rh>1 && new1.binID<new1.parent.binID) {
				...
				binID z = n.left;
				binID temp = new binID(z.parent,z,y.right,y.capacity,y.binID,y.pointbin,y.objects);
				//		System.out.println(y.capacity+""+z.capacity);
			...
			if(lh-rh<-1 && new1.binID>new1.parent.binID) {  
				...
				binID z = n.right;
				binID temp = new binID(z.parent,y.left,z,y.capacity,y.binID,y.pointbin,y.objects);
				//	System.out.println(y.capacity+""+z.capacity);
			...
			if(lh-rh>1 && new1.binID<new1.parent.binID) {
				...
				//	System.out.println(y.capacity+""+z.capacity+""+temp.capacity);
				if(y.right!=null) {
					temp.left = new binID(y.parent,y.right.left,y.right.right,y.right.capacity,y.right.binID,z.right.pointbin,z.objects);
					temp.left.parent=temp;
				}else
					temp.left=null;
	...
	public static void DeleteObject(int rem){
		...
		binID b = new binID();
		b=remove.pointBinID;
		//System.out.println(remove.objectID+"tt");
		Bin b1 = new Bin();
		b1=remove.pointbin;
...
//		}
	...
	public static void PrintBin(int id){
		...
		for(int i=0;i<b.objects.size();i++) {
			System.out.println(b.objects.get(i).id+" "+b.objects.get(i).capacity);
		}
	}
...
//		System.out.println("");
	...
	public static void Print(Bin n) {
		if(n==null)
			return;
		System.out.println(n.capacity+"tanmay"+n.pointBinID.binID);
		if(n.left!=null)
			Print(n.left);
