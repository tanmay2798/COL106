...
public class SpendRecyclerViewAdapter extends RecyclerView.Adapter<SpendRecyclerViewAdapter.ViewHolder> {
    ...
    public SpendRecyclerViewAdapter(Context context, ArrayList<String> names, ArrayList<String> spends, ArrayList<String> body,int[]color,ArrayList<String> month,ArrayList<String> date) {
        company = names;
        spenditure=spends;
        bodys=body;
        colours=color;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_listitemspend, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(mContext, bodys.get(position), Toast.LENGTH_SHORT).show();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            circleColor = (Button) itemView.findViewById(R.id.buttoncircles);
            m=itemView.findViewById(R.id.month);
