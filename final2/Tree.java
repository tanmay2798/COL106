...
public class Tree {
	...
	public static void PrintEmployeesin(Node3 n3) {
		...
		System.out.println(n3.element+"jiji");
		if(n3.right!=null)
	...
	public static void AddEmployee(String emp,String bos){
		...
		n3.right=null;
		n3.point=new1;
		System.out.println(n3.point.object+"kshitij"+new1.object+"tanmay"+n3.element);
		n3.parent=n3old;
	}
	...
	public static void DeleteEmployee(String rem,String add){
		...
		System.out.println(rem+"tanmay");
		System.out.println(old.element+"1tanmay");
		System.out.println(old.point.object+"utkarsh1");
		if(old.point.level == new1.point.level) {
			...
			System.out.println(old.point.object+"utkarsh"+old.point.level);
			System.out.println(old.point.parent.children.removeElement(old.point)+"");
			deleteFromBST(old);
		}else {
